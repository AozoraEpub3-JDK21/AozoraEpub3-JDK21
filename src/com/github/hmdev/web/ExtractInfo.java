...
public class ExtractInfo
{
	enum ExtractId {
		 ...
		 * 説明文にタブ・カンマ・コロンを含めないこと (extract.txt のパースが
		 * タブを列区切り、カンマを候補区切り、コロン後の末尾数値を index に使うため) */
		DEFUNCT,
		COOKIE, PAGE_REGEX,
		SERIES, TITLE, AUTHOR, DESCRIPTION, COVER_IMG, COVER_HREF,
		PAGE_NUM, PAGE_URL,
		CHILD_NODE, HREF, HREF_REGEX, UPDATE, SUB_UPDATE, CONTENT_UPDATE_LIST, CONTENT_PUBLISH_LIST, SUBTITLE_LIST,
